 ...
 *
 * A UserOperation is not sent directly to the blockchain. Instead it is sent to a
 * bundler which batches it with other UserOps into a single transaction calling
 * the EntryPoint contract's {@code handleOps()} function.
 *
 * <pre>
...
public class UserOperation {
    ...
    /**
     * Compute the userOpHash as defined by ERC-4337:
    ...
    /**
     * Sign this UserOperation with the given wallet.
     * Returns a new UserOperation with the signature field populated.
     */
    ...
    private byte[] pack() {
        return AbiCodec.encode(
            ...
            new Object[]{
                sender,
                nonce,
                Keccak.hash(initCode != null && initCode.length() > 2 ? Hex.decode(initCode) : new byte[0]),
                Keccak.hash(callData != null && callData.length() > 2 ? Hex.decode(callData) : new byte[0]),
                callGasLimit,
                verificationGasLimit,
                preVerificationGas,
                maxFeePerGas,
                maxPriorityFeePerGas,
                Keccak.hash(paymasterAndData != null && paymasterAndData.length() > 2 ? Hex.decode(paymasterAndData) : new byte[0])
            }
        );
    }
    ...
    public static class Builder {
        ...
        public Builder nonce(long v)                       { this.nonce = BigInteger.valueOf(v); return this; }
        public Builder initCode(String v)                  { this.initCode = v; return this; }
        public Builder callData(String v)                  { this.callData = v; return this; }
        public Builder callGasLimit(BigInteger v)          { this.callGasLimit = v; return this; }
        public Builder verificationGasLimit(BigInteger v)  { this.verificationGasLimit = v; return this; }
        public Builder preVerificationGas(BigInteger v)    { this.preVerificationGas = v; return this; }
        ...
        public Builder paymasterAndData(String v)          { this.paymasterAndData = v; return this; }
