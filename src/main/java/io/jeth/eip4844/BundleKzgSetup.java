 ...
 *
 * <p>The Ethereum KZG trusted setup from the ceremony at
 * <a href="https://ceremony.ethereum.org">ceremony.ethereum.org</a>
 * is required for computing blob commitments and proofs (EIP-4844).
 *
 * <p>This tool downloads {@code trusted_setup.txt} from the Ethereum consensus-spec-tests
 * repository, parses and validates it, compresses it to a compact binary format (~200KB),
 * and writes it to {@code src/main/resources/io/jeth/eip4844/kzg-setup.bin}.
 *
 ...
 * </pre>
 *
 * <p>The downloaded file's SHA256 is verified against the known-good hash from the
...
public class BundleKzgSetup {
    ...
    public static void main(String[] args) throws Exception {
        String outputPath = args.length > 0 ? args[0]
            : "src/main/resources/io/jeth/eip4844/kzg-setup.bin";
        ...
        try {
            ...
            System.out.println("Parsed " + setup.g1.length + " G1 points, " + setup.g2Raw.length + " G2 points.");
