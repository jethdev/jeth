...
public class TypeMapper {
    ...
    /**
     * Java type for a Solidity type in method signatures.
     * e.g. "uint256" -> "BigInteger", "address" -> "String", "bool" -> "boolean"
     */
    ...
    /**
     * Cast expression to convert Object (from ABI decoded array) to the target Java type.
     * e.g. for "uint256": "(BigInteger) result[0]"
     */
    ...
    /**
     * AbiType constant name for a Solidity type, used in Function.of() calls.
     * e.g. "uint256" -> "AbiType.UINT256", "address" -> "AbiType.ADDRESS"
     */
