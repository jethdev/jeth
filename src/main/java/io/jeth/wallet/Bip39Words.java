...
/**
 * Complete BIP-39 English wordlist — 2048 words, embedded directly. Source:
 * github.com/trezor/python-mnemonic (MIT licence)
 *
 * <p>No resource file, no network call, no setup required. HdWallet.generate() works out of the
 * box.
 */
    ...
    static {
        if (WORDS.length != 2048)
            throw new ExceptionInInitializerError(
                    "BIP-39 wordlist integrity check failed: expected 2048 words, got "
                            + WORDS.length);
    }
}
