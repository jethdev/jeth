...
/**
 * Complete BIP-39 English wordlist — 2048 words, embedded directly.
 * Source: github.com/trezor/python-mnemonic (MIT licence)
 *
 * No resource file, no network call, no setup required.
 * HdWallet.generate() works out of the box.
 */
final class Bip39Words {

    private Bip39Words() {}

    // 2048 words, one per line — split at class-load time
    private static final String RAW =
        ...
        "immune impact impose improve impulse inbox income increase index indicate " +
        "indoor industry infant inflict inform inhale inject inner innocent input " +
        "inquiry insane insect inspire install intact interest into invest invite " +
        ...
        "kiwi knee knife knock know lab label lamp language laptop " +
        "large later laugh laundry lava law lawn lawsuit layer lazy " +
        "leader learn leave lecture left leg legal legend leisure lemon " +
        "lend length lens leopard lesson letter level liar liberty library " +
        "license life lift like limb limit link lion liquid list " +
        ...
        "master match material math matter maximum maze meadow mean medal " +
        ...
        "mind minimum minor minute miracle miss mitten mobile model modify " +
        ...
        "old olive olympic omit once onion open opera oppose option " +
        "orange orbit orchard order ordinary organ orient original orphan ostrich " +
        "other outdoor outside oval over own oyster ozone pact paddle " +
        ...
        "provide public pudding pull pulp pulse pumpkin punish pupil purpose " +
        "purse push put puzzle pyramid quality quantum quarter question quick " +
        "quit quiz quote rabbit raccoon race rack radar radio rage " +
        "rail rain raise rally ramp ranch random range rapid rare " +
        "rate rather raven reach ready real reason rebel rebuild recall " +
        ...
        "review reward rhythm ribbon rice rich ride ridge rifle right " +
        "rigid ring riot ripple risk ritual rival river road roast " +
        "robot robust rocket romance roof rookie round route royal rubber " +
        "rude rug rule run runway rural sad saddle sadness safe " +
        "sail salad salmon salon salt salute same sample sand satisfy " +
        "satoshi sauce sausage save say scale scan scatter scene scheme " +
        ...
        "shuffle shy sibling siege sight sign silent silk silly silver " +
        "similar simple since sing siren sister situate six size sketch " +
        ...
        "solar soldier solid solution solve someone song soon sorry soul " +
        "sound soup source south space spare spatial spawn speak special " +
        "speed sphere spice spider spike spin spirit split spoil sponsor " +
        "spoon spray spread spring spy square squeeze squirrel stable stadium " +
        "staff stage stairs stamp stand start state stay steak steel " +
        "stem step stereo stick still sting stock stomach stone stop " +
        "store storm story stove strategy street strike strong struggle student " +
        ...
        "well west wet whale wheat wheel when where whip whisper " +
    ...
    static final String[] WORDS = RAW.split(" ");

    static {
        if (WORDS.length != 2048)
            throw new ExceptionInInitializerError(
                "BIP-39 wordlist integrity check failed: expected 2048 words, got " + WORDS.length);
    }
}
