...
/**
 * Untyped dynamic contract — no interface needed at all.
 * Use when you just want to fire calls without defining an interface.
 *
 * <pre>
...
public class DynamicContract {
    ...
    public CompletableFuture<Object> call(String functionName, Object... args) {
        return get(functionName).call(args).raw()
                .thenApply(arr -> arr.length == 1 ? arr[0] : arr);
    }
     ...
     */
    public CompletableFuture<String> sendPayable(String functionName, Wallet wallet,
                                                  BigInteger ethValue, Object... args) {
