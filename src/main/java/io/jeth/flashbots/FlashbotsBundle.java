...
public final class FlashbotsBundle {
    ...
    public List<String> rawTxs() {
        return rawTxs;
    }

    public List<String> revertingTxHashes() {
        return revertingTxHashes;
    }
    ...
    public static final class Builder {
        ...
        /**
         * Add a transaction that MUST succeed. If it reverts, the entire bundle is dropped.
         *
        ...
        /**
         * Add a transaction that is allowed to revert. The bundle will still be included even if
         * this tx fails. The tx hash will be added to {@code revertingTxHashes}.
         *
         * <p>Useful for "backrun" transactions that only have value in specific conditions.
         *
         * @param signedRawTx 0x-prefixed signed raw transaction hex
    ...
    public String toString() {
        return "FlashbotsBundle{txs="
                + rawTxs.size()
                + (revertingTxHashes.isEmpty()
                        ? ""
                        : ", revertingTxHashes=" + revertingTxHashes.size())
                + "}";
    }
}
