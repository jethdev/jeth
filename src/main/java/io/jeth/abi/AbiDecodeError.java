...
public final class AbiDecodeError {
    ...
    private static final Map<Integer, String> PANIC_CODES = Map.of(
        0x00, "generic panic",
    ...
    /**
     * Decode a revert reason from raw hex revert data.
     * Returns a human-readable string.
     */
    public static String decode(String hexData) {
        if (hexData == null || hexData.isEmpty() || hexData.equals("0x")) return "execution reverted (no reason)";
        try {
     ...
     * e.g. errorSelector("InsufficientBalance(address,uint256)")
     */
