...
/**
 * Extended AbiCodec tests covering type-specific encode/decode paths not exercised by the existing
 * AbiCodecTest: signed integers, fixed-size bytes, tuples, arrays, and the low-level
 * decodeValue/decodeAddress/decodeFixedBytes helpers.
 */
class AbiCodecExtendedTest {
    ...
    @Nested
    @DisplayName("Signed integers")
    class SignedIntegers {

        @Test
        @DisplayName("encodeInt then decodeSignedInt roundtrip: positive")
        ...
        @Test
        @DisplayName("encodeInt then decodeSignedInt roundtrip: negative")
        ...
        @Test
        @DisplayName("encodeInt: -1 as int256 = 0xff...ff (all ones)")
        ...
        @Test
        @DisplayName("decodeSignedInt: int8 max positive = 127")
        void int8_max() {
        ...
        @Test
        @DisplayName("decodeSignedInt: int8 min negative = -128 (0x80 in MSB)")
        void int8_min() {
        ...
        @Test
        @DisplayName("encode/decode int256 via AbiType roundtrip")
        ...
        @Test
        @DisplayName("encode/decode int8 negative roundtrip")
        ...
        @Test
        @DisplayName("encode/decode int128 max/min roundtrip")
    ...
    @Nested
    @DisplayName("Fixed bytes")
    class FixedBytes {

        @Test
        @DisplayName("encodeFixedBytes left-pads to 32 bytes")
        ...
        @Test
        @DisplayName("decodeFixedBytes recovers original bytes")
        ...
        @Test
        @DisplayName("bytes4 roundtrip via AbiType")
        ...
        @Test
        @DisplayName("bytes32 full slot roundtrip")
    ...
    class Tuples {
        ...
        @Test
        @DisplayName("encodeTuple: (address, uint256) roundtrip")
        ...
        @Test
        @DisplayName("tuple with dynamic string member")
        ...
        @Test
        @DisplayName("nested tuple: ((uint256,bool), address)")
        void nested_tuple() {
        ...
        @Test
        @DisplayName("Uniswap-style QuoteParams tuple: (address,address,uint256,uint24,uint160)")
    ...
    class Arrays {
        ...
        @Test
        @DisplayName("dynamic uint256[] roundtrip")
        ...
        @Test
        @DisplayName("fixed uint256[3] roundtrip")
        ...
        @Test
        @DisplayName("empty dynamic array encodes/decodes correctly")
        void empty_array() {
            AbiType t = AbiType.of("uint256[]");
    ...
    @Nested
    @DisplayName("Low-level decode helpers")
    class LowLevelDecode {

        @Test
        @DisplayName("decodeAddress extracts checksummed address from 32-byte slot")
        void decode_address() {
            String addr = "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266";
        ...
        @Test
        @DisplayName("decodeAddress result is EIP-55 checksummed")
        void decode_address_checksummed() {
            ...
            assertFalse(
                    dec.substring(2).equals(dec.substring(2).toLowerCase()),
                    "decoded address must be EIP-55 checksummed, got: " + dec);
        }

        @Test
        @DisplayName("decodeBigInt handles zero")
        ...
        @Test
        @DisplayName("decodeBigInt handles max uint256")
        ...
        @Test
        @DisplayName("decodeValue dispatches correctly for uint type")
        ...
        @Test
        @DisplayName("decodeValue dispatches correctly for bool type")
        ...
        @Test
        @DisplayName("decodeValue dispatches correctly for address type")
        ...
        @Test
        @DisplayName("decodeFixedBytes at non-zero offset")
    ...
    @Nested
    @DisplayName("Mixed type roundtrips")
    class MixedTypes {

        @Test
        @DisplayName("(address, int256, bool, bytes32, string) full roundtrip")
        void all_types_roundtrip() {
            AbiType[] types = {
                AbiType.ADDRESS, AbiType.INT256, AbiType.BOOL, AbiType.of("bytes32"), AbiType.STRING
            };
            String addr = "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266";
        ...
        @Test
        @DisplayName("(uint256, uint256[]) mixed static+dynamic")
