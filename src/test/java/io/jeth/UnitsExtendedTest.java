...
class UnitsExtendedTest {
    ...
    @Test
    @DisplayName("toWei(double) round-trips for common values")
    void to_wei_double() {
    ...
    @Test
    @DisplayName("formatEther with max decimals=2")
    ...
    @Test
    @DisplayName("parseToken with 6 decimals (USDC)")
    ...
    @Test
    @DisplayName("parseToken with 18 decimals")
    void parse_token_18() {
    ...
    @Test
    @DisplayName("formatToken with 6 decimals")
    void format_token_6() {
        assertEquals("1.0", Units.formatToken(BigInteger.valueOf(1_000_000), 6));
    }

    @Test
    @DisplayName("formatGwei converts wei to gwei string")
    void format_gwei() {
        assertEquals("30.0", Units.formatGwei(BigInteger.valueOf(30_000_000_000L)));
    }

    @Test
    @DisplayName("formatGasCostEth returns non-empty string")
    ...
    @Test
    @DisplayName("MAX_UINT256 is 2^256 - 1")
    void max_uint256() {
        assertEquals(BigInteger.TWO.pow(256).subtract(BigInteger.ONE), Units.MAX_UINT256);
    }

    @Test
    @DisplayName("toWei / formatEther inverse for small decimals")
