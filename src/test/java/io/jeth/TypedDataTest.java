...
class TypedDataTest {
    ...
    @Test
    @DisplayName("EIP712Domain typehash matches spec")
    ...
    @Test
    @DisplayName("encodeType produces canonical signature string")
    void encode_type() {
        var types =
                Map.of(
                        "Mail",
        ...
        assertEquals(
                "Mail(address from,address to,string subject)",
                TypedData.encodeType("Mail", types));
    }

    @Test
    @DisplayName("typeHash is keccak256(encodeType)")
    void type_hash() {
    ...
    @Test
    @DisplayName("sign is deterministic (RFC 6979)")
    ...
    @Test
    @DisplayName("signHex returns 132-char 0x hex string")
    void sign_hex() {
        var msg = Map.<String, Object>of("content", "test");
    ...
    @Test
    @DisplayName("different messages → different signatures")
    ...
    @Test
    @DisplayName("different chainId → different signatures")
    ...
    @Test
    @DisplayName("signPermit returns valid 65-byte signature")
    void sign_permit() {
        Signature sig =
    ...
    @Test
    @DisplayName("signPermit is deterministic")
    ...
    @Test
    @DisplayName("encode uint256 value in struct")
