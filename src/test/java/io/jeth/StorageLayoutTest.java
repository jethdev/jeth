...
/**
 * Tests for StorageLayout slot computation — purely algorithmic (no RPC needed). Verifies against
 * known Solidity storage layout rules.
 */
class StorageLayoutTest {
    ...
    @Test
    @DisplayName("mappingSlot: known USDC balances slot")
    ...
    @Test
    @DisplayName("mappingSlot: different addresses give different slots")
    ...
    @Test
    @DisplayName("mappingSlot: different base slots give different results")
    ...
    @Test
    @DisplayName("mappingSlot: result is 256-bit (fits in 32 bytes)")
    void mapping_slot_256bit() {
        BigInteger slot =
                StorageLayout.mappingSlot(0, "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266");
    ...
    @Test
    @DisplayName("unpackSlot: extract lowest byte")
    ...
    @Test
    @DisplayName("unpackSlot: extract byte at offset 1")
    ...
    @Test
    @DisplayName("unpackSlot: extract 2-byte value")
    ...
    @Test
    @DisplayName("unpackSlot: packed bool (1 byte) at offset 20 (after address)")
    ...
    @Test
    @DisplayName("unpackSlot: zero returns zero for any offset/length")
    ...
    @Test
    @DisplayName("Array element 0 is at keccak256(baseSlot)")
