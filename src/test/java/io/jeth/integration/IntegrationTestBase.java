...
class IntegrationTestBase {
    ...
    /**
     * Deploy a contract from 0x-prefixed bytecode using the dev wallet. Returns the deployed
     * contract address.
     */
    static String deploy(EthClient client, Wallet deployer, String bytecode) {
        ...
        var tx =
                EthModels.TransactionRequest.builder()
                        ...
                        .build();
        String txHash =
                client.sendRawTransaction(TransactionSigner.signEip1559(tx, deployer)).join();
