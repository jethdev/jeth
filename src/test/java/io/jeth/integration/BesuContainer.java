 ...
 *
 * <p>Started automatically by @Testcontainers when {@link BesuIntegrationTest} runs. Requires
 * Docker to be available — tests are tagged "integration" and skipped otherwise.
 */
public class BesuContainer extends GenericContainer<BesuContainer> {
    ...
    public String wsUrl() {
        return "ws://" + getHost() + ":" + getMappedPort(WS);
    }
}
