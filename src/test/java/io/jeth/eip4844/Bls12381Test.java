...
/**
 * Tests for BLS12-381 field and G1 group arithmetic. Uses known constants from the BLS12-381 spec
 * and IETF drafts.
 */
class Bls12381Test {
    ...
    void generatorIsOnCurve() {
        ...
        BigInteger rhs =
                Bls12381.fpAdd(Bls12381.fpMul(Bls12381.fpMul(x, x), x), BigInteger.valueOf(4));
    ...
    private static void assertG1Equal(Bls12381.G1 expected, Bls12381.G1 actual, String msg) {
        ...
        assertFalse(
                expected.isInfinity() ^ actual.isInfinity(),
                msg + " (one is infinity, other isn't)");
